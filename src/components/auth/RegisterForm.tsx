...
const RegisterForm = () => {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        // console.log('no run but register success')
        // registerApi(user)
    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className='my-3'>
                ...
                <input type="text" id='name' className='w-full p-3 border' required
            ...
            <div className='my-3'>
                ...
                <input type="password" id='cf_password' className='w-full p-3 border' required
