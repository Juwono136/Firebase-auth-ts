...
import { facebookApi, forgotPasswordApi, googleApi, loginApi, registerApi, signOutApi } from 'redux/actions/authActions'
...
const authSlice = createSlice({
    ...
    initialState,
    reducers: {
        addUser: (state: { currentUser: any }, action: { payload: any }) => {
            // console.log(action)
